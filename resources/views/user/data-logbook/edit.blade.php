                            ...
                            <div class="row"> 
                                <div class="col-md-6 mb-3 has-validation">
                                    ...
                                    <input type="text" name="nama_pasien" class="form-control" id="validationnamapasien" placeholder="Nama Pasien"
                                        aria-label="Nama Pasien" value="{{$logbook->nama_pasien}}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="umur" class="form-control" id="validationumur" placeholder="Umur"
                                        aria-label="Umur" value="{{$logbook->umur}}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="mr" class="form-control" placeholder="Mr"
                                        aria-label="mr" value="{{$logbook->mr}}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="diagnosis_masuk" class="form-control" placeholder="Diagnosis Masuk"
                                        aria-label="Diagnosis Masuk" value="{{$logbook->diagnosis_masuk}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="diagnosis_keluar" class="form-control" placeholder="Diagnosis Keluar"
                                        aria-label="Diagnosis Keluar" value="{{$logbook->diagnosis_keluar}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="tindakan"  class="form-control" id="validationtindakan" placeholder="Tindakan"
                                        aria-label="Tindakan" value="{{$logbook->tindakan}}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="dpjp" class="form-control" placeholder="DPJP"
                                        aria-label="DPJP" value="{{$logbook->dpjp}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="klasifikasi_kasus" class="form-control" placeholder="Klasifikasi Kasus"
                                        aria-label="Klasifikasi Kasus" value="{{$logbook->klasifikasi_kasus}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-12 mb-3">
                                            <select id="inputState1" name="kasus_obstetri" class="form-select">
                                                ...
                                                <option value="diagnosis_obstetri"<?php if($logbook->kasus_obstetri=="diagnosis_obstetri") { echo "selected"; } ?>>Diagnosis Obstetri</option>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-12 mb-3">
                                            <select id="inputState1" name="kasus_ginekologi" class="form-select">
                                                 <option selected disabled>--Option--</option>
                                                <option value="diagnosis_ginekologi"<?php if($logbook->kasus_ginekologi=="diagnosis_ginekologi") { echo "selected"; } ?>>Diagnosis Ginekologi</option>
                                ...
                                <div class="col-xl-12 mb-3">
                                    ...
                                    <input type="text" name="level_kompetensi" class="form-control" placeholder="Level Kompetensi"
                                        aria-label="Level Kompetensi" value="{{$logbook->level_kompetensi}}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label class="form-label">Asal Rujukan</label>
                                    <input type="text" name="asal_rujukan" class="form-control" placeholder="Asal Rujukan"
                                        aria-label="Asal Rujukan" value="{{$logbook->asal_rujukan}}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label for="text-area" class="form-label">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" id="text-area" placeholder="Keterangan">{{$logbook->keterangan}}</textarea>
                                        ...
                                        <div class="col-xxl-6 col-xl-12 mb-3">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="tanggal_masuk" class="form-control" id="date" placeholder="dd/mm/yyyy" value="{{$logbook->tanggal_masuk}}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-12 mb-3">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                                    <input type="text" name="tanggal_tindakan" class="form-control" id="date" placeholder="dd/mm/yyyy" value="{{$logbook->tanggal_tindakan}}">
                                                </div>
                                            </div>
                                        </div>
